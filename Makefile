...
frontend: ## Build the React frontend into awsflow/static/
...
clean: ## Remove build artifacts
	rm -rf awsflow/static/assets awsflow/static/index.html awsflow/static/vite.svg
	rm -rf dist/ build/ *.egg-info awsflow.egg-info
...
dev: ## Run frontend dev server and backend API concurrently (requires tmux or parallel)
	...
	@$(PYTHON) -m uvicorn awsflow.app.main:app --reload --port 8000 & \
